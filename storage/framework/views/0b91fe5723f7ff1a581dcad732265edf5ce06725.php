                ...
                <table class="display school-table school-table-style" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td> <?php echo e($discount_amount); ?>  (<?php echo e($currency); ?>)</td>
                            <td><?php echo e($fine); ?>  (<?php echo e($currency); ?>)</td>
                            <td><?php echo e($paid); ?>  (<?php echo e($currency); ?>)</td>
                            <td>
                                <?php 
...
<?php echo e($payment->payment_date != ""? App\SmGeneralSettings::DateConvater($payment->payment_date):''); ?>
                        ...
                        <tr>
                            ...
                            <td><?php if(in_array($fees_discount->id, $applied_discount)): ?>
                                ...
                                ?>
                                <a href="#" data-toggle="tooltip" data-placement="right" title="<?php echo e('Collected By: '.@$created_by->full_name); ?>">Discount of (<?php echo e($currency); ?>)<?php echo e(@$fees_discount->feesDiscount->amount); ?> </a>
                                
                                <?php else: ?>
                                <?php echo app('translator')->getFromJson('lang.discount_of'); ?>  (<?php echo e($currency); ?>)<?php echo e($fees_discount->feesDiscount !=""?$fees_discount->feesDiscount->amount:""); ?> <?php echo app('translator')->getFromJson('lang.assigned'); ?>
                                <?php endif; ?>
                            </td>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th></th>
                            <th><?php echo e($grand_total); ?>  (<?php echo e($currency); ?>)</th>
                            <th></th>
                            <th></th>
                            <th></th>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/feesCollection/fees_statment.blade.php ENDPATH**/ ?>