                                ...
                                <div class="row  mt-40">
                                    <div class="col-lg-12">
                                        ...
                                        <select class="niceSelect w-100 bb form-control<?php echo e(@$errors->has('type') ? ' is-invalid' : ''); ?>" name="type">
                                            ...
                                            <?php else: ?>
                                            <option value="I" <?php echo e(old('type')!=''? (old('type') == 'I'? 'selected':''):''); ?>><?php echo app('translator')->getFromJson('lang.income'); ?></option>
                                            <?php endif; ?>
                                            <?php if(isset($chart_of_account)): ?>
                                            <option value="E" <?php echo e(@$chart_of_account->type == 'E'? 'selected':''); ?>><?php echo app('translator')->getFromJson('lang.expense'); ?></option>
                                            <?php else: ?>
                                            <option value="E" <?php echo e(old('type')!=''? (old('type') == 'E'? 'selected':''):''); ?>><?php echo app('translator')->getFromJson('lang.expense'); ?></option>
                                            <?php endif; ?>
                                        </select>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/accounts/chart_of_account.blade.php ENDPATH**/ ?>