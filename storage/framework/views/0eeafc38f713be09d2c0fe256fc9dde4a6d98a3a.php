<html>
	...
	<head>
		<title><?php echo app('translator')->getFromJson('lang.student_certificate'); ?></title>
		...
		<div class="DivBody">
			...
			<table width="80%" align="center">
				<tr>
					...
					<td style="text-align: right;" class="tdWidth"><?php echo app('translator')->getFromJson('lang.date'); ?>: <?php echo e(@$certificate->date); ?></td>
				</tr>
				<tr>
...
<?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/admin/student_certificate_print.blade.php ENDPATH**/ ?>