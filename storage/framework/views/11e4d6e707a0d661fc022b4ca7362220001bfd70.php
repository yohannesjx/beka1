...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->getFromJson('lang.base_setup'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(url('dashboard')); ?>"><?php echo app('translator')->getFromJson('lang.dashboard'); ?></a>
                <a href="#"><?php echo app('translator')->getFromJson('lang.system_settings'); ?></a>
                <a href="#"><?php echo app('translator')->getFromJson('lang.base_setup'); ?></a>
            </div>
        </div>
    </div>
</section>
                    ...
                    <div class="col-lg-12">
                        <div class="main-title">
                            <h3 class="mb-30"><?php if(isset($base_setup)): ?>
                                ...
                                <?php endif; ?>
                                <?php echo app('translator')->getFromJson('lang.base_setup'); ?>
                            </h3>
                        </div>
                        <?php if(isset($base_setup)): ?>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('base_group') ? ' is-invalid' : ''); ?>"
                                            name="base_group">
                                            <option data-display="<?php echo app('translator')->getFromJson('lang.base_group'); ?> *" value=""><?php echo app('translator')->getFromJson('lang.base_group'); ?>*</option>
            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-0"><?php echo app('translator')->getFromJson('lang.base_setup'); ?> <?php echo app('translator')->getFromJson('lang.list'); ?></h3>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="display school-table school-table-data" cellspacing="0" width="100%">
                            <thead>
                                ...
                                <tr>
                                 ...
                                 <?php endif; ?>
                                <tr>
                                    <th width="33%"><?php echo app('translator')->getFromJson('lang.base'); ?> <?php echo app('translator')->getFromJson('lang.type'); ?></th>
                                    <th width="33%"><?php echo app('translator')->getFromJson('lang.label'); ?></th>
                                    <th width="33%"><?php echo app('translator')->getFromJson('lang.action'); ?></th>
                                </tr>
                            </thead>
                                                                ...
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        <?php if(in_array(430, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                                                                            <a class="dropdown-item" href="<?php echo e(route('base_setup_edit', [@$base_setup->id])); ?>"><?php echo app('translator')->getFromJson('lang.edit'); ?></a>
                                                                        <?php endif; ?>
                                                                        <?php if(in_array(431, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                                                                            <a class="dropdown-item deleteBaseSetupModal" href="#" data-toggle="modal" data-target="#deleteBaseSetupModal" data-id="<?php echo e(@$base_setup->id); ?>"><?php echo app('translator')->getFromJson('lang.delete'); ?></a>
                                                                        <?php endif; ?>
                                                                    </div>
                                                                </div>
                                                            </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><?php echo app('translator')->getFromJson('lang.delete'); ?> <?php echo app('translator')->getFromJson('lang.base_setup'); ?></h4>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/systemSettings/baseSetup/base_setup.blade.php ENDPATH**/ ?>