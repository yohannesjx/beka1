        ...
        <div class="row">
            <div class="offset-lg-10 col-lg-2 text-right col-md-12">
                <a href="<?php echo e(url('database-upgrade')); ?>" class="primary-btn small fix-gr-bg">
                    ...
                    <?php echo app('translator')->getFromJson('lang.database'); ?>   <?php echo e(__('sync')); ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/101.infixedu.v5/resources/views/backEnd/systemSettings/updateSettings.blade.php ENDPATH**/ ?>