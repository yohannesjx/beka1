    ...
    <section class="admin-visitor-area">
        <div class="container-fluid p-0">
            <?php if(isset($edit_languages)): ?>
                <?php if(in_array(452, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                    <div class="row">
                                ...
                                <?php $__currentLoopData = $sms_languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sms_language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <?php if(in_array(453, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                                                <a href="<?php echo e(URL::to('/change-language/'.@$sms_language->id)); ?>"
                                                    class="<?php echo e(@$sms_language->active_status==1?@$active:@$inactive); ?> "   > <span
                                            ...
                                            <?php if(in_array(454, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                                            <a href="<?php echo e(url('/')); ?>/language-setup/<?php echo e(@$sms_language->language_universal); ?> "
                                              ...
                                              <?php if(in_array(455, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                                                    <a 
                                                   href="<?php echo e(url('/')); ?>/language-delete" class="primary-btn small tr-bg white_space" data-toggle="modal"
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/systemSettings/languageSettings.blade.php ENDPATH**/ ?>