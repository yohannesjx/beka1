            ...
            <div class="col-lg-12 table-responsive">
                <table class="display school-table school-table-style" cellspacing="0" width="100%">
                    <thead>
                        ...
                        <tr>
                            <td class="text-right" colspan="14">
                                <a href="" id="fees_groups_invoice_print_button" class="primary-btn medium fix-gr-bg" target="">
                                    ...
                                    <?php echo app('translator')->getFromJson('lang.invoice_print'); ?>
                                </a>
                            </td>
                        ...
                        <tr>
                            <th>#</th>
                            <th><?php echo app('translator')->getFromJson('lang.fees'); ?></th>
                        ...
                        <?php if($fees_discount->feesDiscount->type != "year"): ?>
                            <tr>
                                ...
                                <td><?php if(in_array($fees_discount->id, $applied_discount)): ?>
                                    ...
                                    <a href="#" data-toggle="tooltip" data-placement="right" title="<?php echo e('Collected By: '.$created_by->full_name); ?>"><?php echo app('translator')->getFromJson('lang.discount_of'); ?> $<?php echo e(number_format($fees_discount->feesDiscount->amount, 2, '.', '')); ?> <?php echo app('translator')->getFromJson('lang.applied'); ?> : <?php echo e($createdBy->id.'/'.$createdBy->created_by); ?></a>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <?php echo app('translator')->getFromJson('lang.discount_of'); ?> $<?php echo e(number_format($fees_discount->feesDiscount->amount, 2, '.', '')); ?> <?php echo app('translator')->getFromJson('lang.assigned'); ?>
                                    ...
                                    ?>   
                                        ...
                                        <?php if(@$discount_year != ""): ?>
                                            <?php if(@$created_by != ""): ?>
                                                ...
                                                <a href="#" data-toggle="tooltip" data-placement="right" title="<?php echo e('Collected By: '.$created_by->full_name); ?>"><?php echo app('translator')->getFromJson('lang.discount_of'); ?> <?php echo e($currency); ?><?php echo e(number_format($fees_discount->feesDiscount->amount, 2, '.', '')); ?> <?php echo app('translator')->getFromJson('lang.applied'); ?> : <?php echo e($createdBy->id.'/'.$createdBy->created_by); ?></a>
                                            <?php endif; ?>
                                        <?php else: ?>
                                            <?php echo app('translator')->getFromJson('lang.discount_of'); ?> <?php echo e($currency); ?><?php echo e(number_format($fees_discount->feesDiscount->amount, 2, '.', '')); ?> <?php echo app('translator')->getFromJson('lang.assigned'); ?>
                                        <?php endif; ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/feesCollection/collect_fees_student_wise.blade.php ENDPATH**/ ?>