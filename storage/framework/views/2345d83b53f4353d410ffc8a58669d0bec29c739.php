                                    ...
                                    <?php if(isset($exam_type_edit)): ?>
                                        <div class="col-lg-12 mt-30-md">
                                            <select class="w-100 bb niceSelect form-control <?php echo e($errors->has('active_status') ? ' is-invalid' : ''); ?>" id="active_status" name="active_status">
                                                ...
                                                <option value="1" <?php echo e((@$exam_type_edit->active_status ==1) ? 'selected' :''); ?>> <?php echo app('translator')->getFromJson('lang.active'); ?></option> 
                                                <option value="0" <?php echo e((@$exam_type_edit->active_status ==0) ? 'selected' :''); ?>> <?php echo app('translator')->getFromJson('lang.inactive'); ?></option> 
                                            </select>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/examination/exam_type.blade.php ENDPATH**/ ?>