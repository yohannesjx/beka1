    ...
    <div class="modal-dialog modal-dialog-centered" id="modalSize">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title" id="showDetaildModalTile"><?php echo app('translator')->getFromJson('lang.new_client_information'); ?></h4>
...
<div class="modal fade invoice-details" id="showDetaildModalInvoice">
    <div class="modal-dialog large-modal modal-dialog-centered" >
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><?php echo app('translator')->getFromJson('lang.add'); ?> <?php echo app('translator')->getFromJson('lang.invoice'); ?></h4>
...
<?php /**PATH /Applications/MAMP/htdocs/version/InfixEduV4.5/resources/views/backEnd/partials/footer.blade.php ENDPATH**/ ?>