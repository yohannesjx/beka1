                    ...
                    <?php endif; ?>
                        ...
                        <div class="white-box">
                            ...
                            <div class="col-lg-12 text-center">
                                ...
                                <?php if(Illuminate\Support\Facades\Config::get('app.app_sync')): ?>
                                    <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Disabled For Demo "> <button class="primary-btn small fix-gr-bg  demo_view" style="pointer-events: none;" type="button" ><?php echo app('translator')->getFromJson('lang.change_logo'); ?></button></span>
                                <?php else: ?>
                                    <?php if(in_array(406, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                ...
                <div class="row mt-40">
                    ...
                    <?php endif; ?>
                        ...
                        <div class="white-box">
                            ...
                            <div class="col-lg-12 text-center">
                                <?php if(Illuminate\Support\Facades\Config::get('app.app_sync')): ?>
                                    <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Disabled For Demo "> <button class="primary-btn small fix-gr-bg  demo_view" style="pointer-events: none;" type="button" ><?php echo app('translator')->getFromJson('lang.change_fav'); ?></button></span>
                                <?php else: ?>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="value text-left">
                                                ...
                                                <?php if(isset($session)): ?>
                                                    <?php echo e(@$session->year != ""? @$session->year:""); ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/version/InfixEduV4.5/resources/views/backEnd/systemSettings/generalSettingsView.blade.php ENDPATH**/ ?>