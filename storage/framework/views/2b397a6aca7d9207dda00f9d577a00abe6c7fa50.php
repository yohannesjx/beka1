        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <ul class="nav nav-tabs tab_column" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#msg91_settings" role="tab" data-toggle="tab"><?php echo app('translator')->getFromJson('lang.msg91'); ?> <?php echo app('translator')->getFromJson('lang.settings'); ?></a>
                    </li> 
                </ul>
            ...
            <?php if(in_array(446, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                                ...
                                <div class="col-md-5">
                                    <div class="row">
                                        <div class="col-lg-12 mb-30">
                                            <div class="input-effect">
                                                ...
                                                type="text" name="twilio_account_sid" autocomplete="off" value="<?php echo e(isset($sms_services)? @$sms_services[0]->twilio_account_sid : ''); ?>" id="twilio_account_sid">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mb-30">
                                            <div class="input-effect">
                                                <input class="primary-input form-control<?php echo e($errors->has('book_title') ? ' is-invalid' : ''); ?>"
                                                type="text" name="twilio_authentication_token" autocomplete="off" value="<?php echo e(isset($sms_services)? @$sms_services[0]->twilio_authentication_token : ''); ?>" id="twilio_authentication_token">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                <input class="primary-input form-control<?php echo e($errors->has('book_title') ? ' is-invalid' : ''); ?>"
                                                type="text" name="twilio_registered_no" autocomplete="off" value="<?php echo e(isset($sms_services)? @$sms_services[0]->twilio_registered_no : ''); ?>" id="twilio_registered_no">
            ...
            <div role="tabpanel" class="tab-pane fade" id="msg91_settings"> 
                <?php if(in_array(447, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                               ...
                               <div class="col-md-5">
                                    <div class="row">
                                        <div class="col-lg-12 mb-30">
                                            ...
                                            <div class="input-effect">
                                                <input class="primary-input form-control<?php echo e($errors->has('book_title') ? ' is-invalid' : ''); ?>"
                                                type="text" id="msg91_authentication_key_sid" name="msg91_authentication_key_sid" autocomplete="off" value="<?php echo e(isset($sms_services)? @$sms_services[1]->msg91_authentication_key_sid : ''); ?>"> 
                                                <label><?php echo app('translator')->getFromJson('lang.authentication'); ?> <?php echo app('translator')->getFromJson('lang.key'); ?> <?php echo app('translator')->getFromJson('lang.sid'); ?> <span>*</span> </label> 
                                                <span class="focus-border"></span>
                                                <?php if($errors->has('book_title')): ?>
                                                <span class="invalid-feedback" role="alert">
                                                    <strong><?php echo e($errors->first('book_title')); ?></strong>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mb-30">
                                            <div class="input-effect">
                                                <input class="primary-input form-control<?php echo e($errors->has('book_title') ? ' is-invalid' : ''); ?>"
                                                type="text" name="msg91_sender_id" autocomplete="off" value="<?php echo e(isset($sms_services)? @$sms_services[1]-> msg91_sender_id : ''); ?>" id="msg91_sender_id">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mb-30">
                                            <div class="input-effect">
                                                <input class="primary-input form-control<?php echo e($errors->has('book_title') ? ' is-invalid' : ''); ?>"
                                                type="text" name="msg91_route" autocomplete="off" value="<?php echo e(isset($sms_services)? @$sms_services[1]-> msg91_route : ''); ?>" id="msg91_route">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                <input class="primary-input form-control<?php echo e($errors->has('book_title') ? ' is-invalid' : ''); ?>"
                                                type="text" name="msg91_country_code" autocomplete="off" value="<?php echo e(isset($sms_services)? @$sms_services[1]-> msg91_country_code : ''); ?>" id="msg91_country_code">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/systemSettings/smsSettings.blade.php ENDPATH**/ ?>