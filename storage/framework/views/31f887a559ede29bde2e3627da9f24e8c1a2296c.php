...
<section class="admin-visitor-area">
    <div class="container-fluid p-0">
        ...
        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'update-school-settings-data', 'method' => 'POST', 'enctype' => 'multipart/form-data'])); ?>
        ...
        <?php
            if(App\SmGeneralSettings::isModule('Saas')== TRUE  && Auth::user()->is_administrator != "yes" ){
                ...
                <div class="white-box">
                    <div class="">
                            ...
                            <div class="col-lg-3">
                                <div class="input-effect">
                                    <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('session_id') ? ' is-invalid' : ''); ?>" name="session_id" id="session_id">
                                        ...
                                        <?php $__currentLoopData = $session_ids; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="row mb-40">
                           ...
                           <div class="col-lg-3">
                                <div class="input-effect">
                                    <select <?php echo e($show_status); ?> class="niceSelect w-100 bb form-control<?php echo e($errors->has('language_id') ? ' is-invalid' : ''); ?>" name="language_id" id="language_id">
                                        ...
                                        <?php if(isset($languages)): ?>
                                            ...
                                            <option value="<?php echo e($value->id); ?>"
                                            <?php if(isset($editData)): ?>
                                            <?php if($system_settings->language_id == $value->id): ?>
                                            selected
                                            <?php endif; ?>
                                            <?php endif; ?>
                                            >
                            ...
                            <div class="col-lg-3">
                                <div class="input-effect">
                                    <select <?php echo e($show_status); ?> class="niceSelect w-100 bb form-control<?php echo e($errors->has('date_format_id') ? ' is-invalid' : ''); ?>" name="date_format_id" id="date_format_id">
                                        ...
                                        <option value="<?php echo e($value->id); ?>"
                                        <?php if(isset($editData)): ?>
                                        <?php if($system_settings->date_format_id == $value->id): ?>
                                        selected
                                        <?php endif; ?>
                                        <?php endif; ?>
                                        ><?php echo e($value->normal_view); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                                    </select>
                                    <span class="focus-border"></span>
                        ...
                        <div class="row mb-40">
                            ...
                            <div class="col-lg-2">
                                    <div class="input-effect">
                                         <select <?php echo e($show_status); ?> name="time_zone" class="niceSelect w-100 bb form-control <?php echo e($errors->has('time_zone') ? ' is-invalid' : ''); ?>" id="time_zone">
                                            ...
                                            <option value="<?php echo e($time_zone->id); ?>" <?php echo e($time_zone->id == $system_settings->time_zone_id? 'selected':''); ?>><?php echo e($time_zone->time_zone); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="col-lg-2">
                                    <div class="input-effect">
                                         <select <?php echo e($show_status); ?> name="currency" class="niceSelect w-100 bb form-control <?php echo e($errors->has('currency') ? ' is-invalid' : ''); ?>" id="currency">
                                            <option data-display="<?php echo app('translator')->getFromJson('lang.select_currency'); ?>" value=""><?php echo app('translator')->getFromJson('lang.select_currency'); ?></option>
                                             <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($currency->code); ?>" <?php echo e(isset($editData)? ($system_settings->currency  == $currency->code? 'selected':''):''); ?>><?php echo e($currency->name); ?> (<?php echo e($currency->code); ?>)</option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                            ...
                            <div class="col-lg-6 d-flex relation-button">
                                <p class="text-uppercase mb-0"><?php echo app('translator')->getFromJson('lang.promossion_without'); ?> <?php echo app('translator')->getFromJson('lang.exam'); ?></p>
                                <div class="d-flex radio-btn-flex ml-30">
                                    <div class="mr-20">
                                        ...
                                        <label for="relationFather"><?php echo app('translator')->getFromJson('lang.enable'); ?></label>
                                    </div>
                                    <div class="mr-20">
                                        ...
                                        <label for="relationMother"><?php echo app('translator')->getFromJson('lang.disable'); ?></label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row md-30 mt-40 d-none">
                            <div class="col-lg-12">
                                <div class="input-effect">
                                <textarea <?php echo e($show_status); ?> class="primary-input form-control" cols="0" rows="4" name="copyright_text" id="copyright_text"><?php echo e(isset($editData) ? $system_settings->copyright_text : old('copyright_text')); ?></textarea>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/101.infixedu.v5/Modules/Saas/Resources/views/systemSettings/updateSchoolSettings.blade.php ENDPATH**/ ?>