                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            ...
                            <div class="input-effect mt-40">
                                ...
                                <label class="textarea-label"><?php echo app('translator')->getFromJson('lang.notice'); ?> <span></span> </label>
                            </div>

                            <div class="input-effect mt-40"> 
                                <input type="checkbox" id="is_published" class="common-checkbox" value="1" name="is_published">
                                <label for="is_published"><?php echo app('translator')->getFromJson('lang.is_published_web_site'); ?></label> 
                            </div>
                        </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/101.infixedu.v5/resources/views/backEnd/communicate/sendMessage.blade.php ENDPATH**/ ?>