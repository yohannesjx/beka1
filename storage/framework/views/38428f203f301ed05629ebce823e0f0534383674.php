...
<head> 
    ...
    <title><?php echo e(__('Login')); ?> | <?php echo e(@$setting->site_title); ?></title>
                        ...
                        <div class="in_login_page_iner">
                            <div class="in_login_page_header">
                                ...
                                <div class="in_single_input">
                                    <input type="text" placeholder="<?php echo app('translator')->getFromJson('lang.enter'); ?> <?php echo app('translator')->getFromJson('lang.email'); ?>" name="email" class="<?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>" value="<?php echo e(old('email')); ?>" id="email-address">
...
<?php /**PATH /Applications/MAMP/htdocs/version/InfixEduV4.5/resources/views/auth/loginCodeCanyon.blade.php ENDPATH**/ ?>