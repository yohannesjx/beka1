        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="main-title">
                    <h3 class="mb-20"><?php echo app('translator')->getFromJson('lang.welcome'); ?> <?php echo app('translator')->getFromJson('lang.to'); ?> <strong> <?php echo e(@$student_detail->full_name); ?></strong> </h3>
                </div> 
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/studentPanel/studentProfile.blade.php ENDPATH**/ ?>