                ...
                <table class="display school-table school-table-style" cellspacing="0" width="100%" >
                    <thead>
                        ...
                        <tr>
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <th><?php echo app('translator')->getFromJson('teacher'); ?> <?php echo app('translator')->getFromJson('remarks'); ?></th>
                        </tr>
                    </thead>
                    <tbody>                        
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                    <input class="primary-input marks_input" type="text" name="marks[<?php echo e($student->id); ?>][<?php echo e($part->id); ?>]" value="<?php echo e(!empty($search_mark)?$search_mark:0); ?>" <?php echo e(@$absent_check->attendance_type == 'A'? 'readonly':''); ?>>
                            ...
                            <td>
                                <div class="input-effect mt-10">
                                <input class="primary-input" type="text" name="teacher_remarks[<?php echo e($student->id); ?>][<?php echo e($part->subject_id); ?>]" value="<?php echo e($teacher_remarks); ?>">
                                <label><?php echo app('translator')->getFromJson('teacher'); ?> <?php echo app('translator')->getFromJson('remarks'); ?></label>
                                <span class="focus-border"></span>
                            </div>
                            </td>
                            ...
                            <td>
                                <div class="input-effect">
                                    ...
                                    <button class="primary-btn small fix-gr-bg" type="button"><?php echo app('translator')->getFromJson('lang.present'); ?></button>
                                    <?php else: ?>
                                    <button class="primary-btn small bg-danger text-white border-0" type="button"><?php echo app('translator')->getFromJson('lang.absent'); ?></button>
                                    <?php endif; ?>
                        ...
                        <tr>
                            <td colspan="<?php echo e(count($marks_entry_form) + 5); ?>" class="text-center">
                                <button type="submit" class="primary-btn fix-gr-bg mt-20">
                                    ...
                                    <?php echo app('translator')->getFromJson('save'); ?> <?php echo app('translator')->getFromJson('marks'); ?>
                                </button>
                            </td>
                        </tr>
                        <?php endif; ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/examination/masks_register_create.blade.php ENDPATH**/ ?>