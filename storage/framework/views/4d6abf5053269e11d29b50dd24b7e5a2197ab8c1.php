    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="<?php echo e(route('exam_schedule_create')); ?>"><?php echo app('translator')->getFromJson('lang.exam_schedule'); ?> <?php echo app('translator')->getFromJson('lang.create'); ?></a>
            </div>
        </div>
    </div>
</section>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 mt-30-md">
                                    <select class="w-100 bb niceSelect form-control<?php echo e($errors->has('exam') ? ' is-invalid' : ''); ?>" name="exam">
                                        <option data-display="Select Exam *" value=""><?php echo app('translator')->getFromJson('lang.select_exam'); ?> *</option>
            ...
            <div class="col-lg-12">
                <table class="display school-table school-table-style" cellspacing="0" width="100%">
                    <thead>
                        ...
                        <?php endif; ?>
                        <tr>
                            <th width="10%"><?php echo app('translator')->getFromJson('lang.subject'); ?></th>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if(@$assigned_routine == ""): ?>
                                    ...
                                    <?php if(in_array(219, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>

                                    <div class="col-lg-6">
                                        <a href="<?php echo e(url('add-exam-routine-modal', [$assign_subject->subject_id, $exam_period->id, $class_id, $section_id, $exam_id])); ?>" class="primary-btn small tr-bg icon-only mr-10 modalLink" data-modal-size="modal-md" title="Create exam routine">
                                ...
                                <?php else: ?>
                                    <div class="col-lg-6">
                                        ...
                                        <a href="<?php echo e(url('edit-exam-routine-modal', [$assign_subject->subject_id, $exam_period->id, $class_id, $section_id, $exam_id, $assigned_routine->id])); ?>" class="modalLink" data-modal-size="modal-md" title="Edit Exam routine"><span class="ti-pencil-alt" id="addClassRoutine"></span></a>

                                        <a href="<?php echo e(url('delete-exam-routine-modal', [$assigned_routine->id])); ?>" class="modalLink" data-modal-size="modal-md" title="Delete exam routine"><span class="ti-trash" id="addClassRoutine"></span></a>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/examination/exam_schedule_create.blade.php ENDPATH**/ ?>