...
<section class="admin-visitor-area up_admin_visitor">
    <div class="container-fluid p-0">
        ...
        <?php if(in_array(295, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 mb-20">
                                        ...
                                        <select class="w-100 bb niceSelect form-control <?php echo e($errors->has('for_whom') ? ' is-invalid' : ''); ?>" id="for_whom" name="for_whom">
                                            <option data-display="<?php echo app('translator')->getFromJson('lang.for_whom'); ?> *" value=""><?php echo app('translator')->getFromJson('lang.for_whom'); ?> *</option>
                                            
                                            <option value="All" <?php echo e(isset($editData)? ($editData->for_whom == 'All'? 'selected' : ''):""); ?>><?php echo app('translator')->getFromJson('lang.all'); ?></option>
                                            <option value="Teacher" <?php echo e(isset($editData)? ($editData->for_whom == 'Teacher'? 'selected' : ''):""); ?>><?php echo app('translator')->getFromJson('lang.teacher'); ?></option>
                                            <option value="Student" <?php echo e(isset($editData)? ($editData->for_whom == 'Student'? 'selected' : ''):""); ?>><?php echo app('translator')->getFromJson('lang.student'); ?></option>
                                            <option value="Parents" <?php echo e(isset($editData)? ($editData->for_whom == 'Parents'? 'selected' : ''):""); ?>><?php echo app('translator')->getFromJson('lang.parents'); ?></option>
                ...
                <div class="col-lg-12">
                    <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                        ...
                        <thead>
                            ...
                            <th><?php echo app('translator')->getFromJson('lang.for_whom'); ?></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e(@$value->from_date != ""? App\SmGeneralSettings::DateConvater(@$value->from_date):''); ?></td>

                          
                            <td  data-sort="<?php echo e(strtotime(@$value->to_date)); ?>" ><?php echo e($value->to_date != ""? App\SmGeneralSettings::DateConvater(@$value->to_date):''); ?></td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                         <?php if(in_array(296, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1  ): ?>
                                         <a class="dropdown-item" href="<?php echo e(url('event/'.$value->id.'/edit')); ?>"><?php echo app('translator')->getFromJson('lang.edit'); ?></a>
                                        <?php endif; ?>
                                         <?php if(in_array(297, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1  ): ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/101.infixedu.v5/resources/views/backEnd/events/eventsList.blade.php ENDPATH**/ ?>