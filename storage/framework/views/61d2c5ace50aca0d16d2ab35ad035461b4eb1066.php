                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-8 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-0"><?php echo app('translator')->getFromJson('lang.fees_collection'); ?> <?php echo app('translator')->getFromJson('lang.list'); ?> (<?php echo app('translator')->getFromJson('lang.class'); ?>: <?php echo e($search_info['class_name']); ?>, <?php echo app('translator')->getFromJson('lang.section'); ?>: <?php echo e(@$search_info['section_name']); ?>, <?php echo app('translator')->getFromJson('lang.keyword'); ?>: <?php echo e(@$search_info['keyword']); ?>)</h3>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-30">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/version/InfixEduV4.5/resources/views/backEnd/feesCollection/collect_fees.blade.php ENDPATH**/ ?>