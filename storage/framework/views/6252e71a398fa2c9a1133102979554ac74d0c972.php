                                    ...
                                    <div class="col-lg-12 mb-30">
                                        <div class="input-effect">
                                            <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('store_id') ? ' is-invalid' : ''); ?>" name="store_id" id="store_id">
                                                <option data-display="Select Store/WareHouse *" value=""><?php echo app('translator')->getFromJson('lang.select'); ?></option>
               ...
               <div class="white-box">
                  ...
                  <tbody>
                      <tr id="row1" class="0">
                        <td class="border-top-0">
                            ...
                            <div class="input-effect">
                                <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('category_name') ? ' is-invalid' : ''); ?>" name="item_id[]" id="productName1">
                                    <option data-display="Select Item " value=""><?php echo app('translator')->getFromJson('lang.select'); ?></option>
                        ...
                        <tfoot>
                            <tr>
                               <th class="border-top-0" colspan="2"><?php echo app('translator')->getFromJson('lang.total'); ?></th>
...
<div class="col-lg-3">
  <select class="niceSelect w-100 bb form-control" name="payment_method" id="payment_method">
    <option data-display="Select Payment Method" value=""><?php echo app('translator')->getFromJson('lang.select'); ?> <?php echo app('translator')->getFromJson('lang.payment_method '); ?></option>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/inventory/itemReceive.blade.php ENDPATH**/ ?>