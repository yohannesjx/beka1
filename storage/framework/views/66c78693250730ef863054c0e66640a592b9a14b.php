    ...
    <div class="container-fluid p-0">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 text_sm_right text_xs_left col-sm-6">
                    <a href="<?php echo e(url('student-attendance-import')); ?>" class="primary-btn small fix-gr-bg pull-right mb-20"><span class="ti-plus pr-2"></span>Import Attendance</a>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-30"><?php echo app('translator')->getFromJson('lang.student_attendance'); ?> | <small><?php echo app('translator')->getFromJson('lang.class'); ?>: <?php echo e($search_info['class_name']); ?>, <?php echo app('translator')->getFromJson('lang.section'); ?>: <?php echo e($search_info['section_name']); ?>, <?php echo app('translator')->getFromJson('lang.date'); ?>: <?php echo e(App\SmGeneralSettings::DateConvater($search_info['date'])); ?></small></h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/studentInformation/student_attendance.blade.php ENDPATH**/ ?>