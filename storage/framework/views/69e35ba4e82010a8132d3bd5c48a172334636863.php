...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->getFromJson('lang.language'); ?> <?php echo app('translator')->getFromJson('lang.settings'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(url('dashboard')); ?>">Dashboard</a>
                <a href="#"><?php echo app('translator')->getFromJson('lang.system'); ?> <?php echo app('translator')->getFromJson('lang.settings'); ?></a>
                <a href="#"><?php echo app('translator')->getFromJson('lang.language'); ?> <?php echo app('translator')->getFromJson('lang.settings'); ?></a>
            </div>
        </div>
    </div>
</section>
                    ...
                    <div class="col-lg-3 mb-30">
                        <div class="white-box onchangeSearch">
                            <select class="w-100 bb niceSelect form-control <?php echo e($errors->has('module_id') ? ' is-invalid' : ''); ?>" id="module_id" name="module_id">
                                <option data-display="Select Module *" value=""><?php echo app('translator')->getFromJson('lang.select'); ?> <?php echo app('translator')->getFromJson('lang.module'); ?> *</option>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/systemSettings/languageSetup.blade.php ENDPATH**/ ?>