...
<section class="sms-breadcrumb mb-40 white-box up_breadcrumb">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->getFromJson('lang.manage'); ?> <?php echo app('translator')->getFromJson('lang.admission_query'); ?></h1>
            <div class="bc-pages">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect">
                                         <select name="source" class="niceSelect w-100 bb form-control <?php echo e($errors->has('select_source') ? ' is-invalid' : ''); ?>" required>
                                            <option data-display="<?php echo app('translator')->getFromJson('lang.select_source'); ?> *" value=""><?php echo app('translator')->getFromJson('lang.select_source'); ?> *</option>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/admin/admission_query.blade.php ENDPATH**/ ?>