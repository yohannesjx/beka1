            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'update-logo', 'method' => 'POST', 'enctype' => 'multipart/form-data'])); ?>
                        ...
                        <div class="white-box">
                            ...
                            <?php else: ?>
                                <img class="img-fluid Img-100" src="<?php echo e(asset('/public/uploads/settings/logo.png')); ?>" alt="">
                            <?php endif; ?>
                            </div>
            ...
            <div class="col-lg-9">
                <div class="row xm_3">
                    ...
                    <?php if(!empty($editData)): ?>
                        ...
                        <a href="<?php echo e(url('update-school-settings')); ?>" class="primary-btn small fix-gr-bg"> <span class="ti-pencil-alt"></span> <?php echo app('translator')->getFromJson('lang.edit'); ?>
                        </a>
                    </div>
                    <?php else: ?>
                         <div class="offset-lg-6 col-lg-2 text-right col-md-6">
                        <a href="<?php echo e(url('add-general-settings')); ?>" class="primary-btn small fix-gr-bg"> <span class="ti-pencil-alt"></span> <?php echo app('translator')->getFromJson('lang.add'); ?>
                        </a>
                    </div>
                    <?php endif; ?>
                            ...
                            <div class="student-meta-box">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="value text-left">
                                                ...
                                                ?>
                                                <?php if(isset($editData)): ?>
                                                    <?php echo e($editData->session_id != ""? @$academic_year->year:""); ?>
                                ...
                                <div class="single-meta">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="name">
                                                <?php echo app('translator')->getFromJson('lang.promossion_without'); ?> <?php echo app('translator')->getFromJson('lang.exam'); ?>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="value text-left">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/101.infixedu.v5/Modules/Saas/Resources/views/systemSettings/schoolGeneralSettingsView.blade.php ENDPATH**/ ?>