                        ...
                        <ul class="nav navbar-nav mr-auto nav-setting flex-sm-row d-none d-lg-block colortheme">
                            <li class="nav-item active">
                                <select class="niceSelect infix_theme_style" id="infix_theme_style">
                                    <option data-display="<?php echo app('translator')->getFromJson('lang.select'); ?> <?php echo app('translator')->getFromJson('lang.style'); ?>" value="0"><?php echo app('translator')->getFromJson('lang.select'); ?> <?php echo app('translator')->getFromJson('lang.style'); ?></option>
                        ...
                        <ul class="nav navbar-nav mr-auto nav-setting flex-sm-row d-none d-lg-block colortheme">
                            <li class="nav-item active">
                                <select class="niceSelect infix_theme_rtl" id="infix_theme_rtl">
                                    <option data-display="<?php echo app('translator')->getFromJson('lang.select'); ?> <?php echo app('translator')->getFromJson('lang.alignment'); ?>" value="0"><?php echo app('translator')->getFromJson('lang.select'); ?> <?php echo app('translator')->getFromJson('lang.alignment'); ?></option>
                                    <?php 
                                    $school_config = App\SmGeneralSettings::where('school_id',Auth::user()->school_id)->first();
                                    $is_rtl = $school_config->ttl_rtl;

                                    ?> 
                                        <option value="2" <?php echo e($is_rtl==2?'selected':''); ?>><?php echo app('translator')->getFromJson('lang.ltl'); ?></option> 
                                        <option value="1" <?php echo e($is_rtl==1?'selected':''); ?>><?php echo app('translator')->getFromJson('lang.rtl'); ?></option> 
                                </select>
                            </li>
                        </ul>
                            ...
                            <?php if(@Auth::user()->role_id==1 && Auth::user()->is_administrator=='yes'): ?>
                                    ...
                                    <li class="nav-item"> 
                                        <select class="niceSelect languageChange" name="languageChange" id="languageChange"> 
                                            <option data-display="<?php echo app('translator')->getFromJson('lang.select'); ?> <?php echo app('translator')->getFromJson('lang.language'); ?>" value="0"><?php echo app('translator')->getFromJson('lang.select'); ?> <?php echo app('translator')->getFromJson('lang.language'); ?></option>
                                            <?php  
                                    ...
                                    <div class="white-box">
                                        ...
                                        <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <a class="dropdown-item pos-re"
                                               href="<?php echo e(@$notification->url? url($notification->url) : url('view/single/notification/'.$notification->id)); ?>">
                                                <div class="">
                                                    ...
                                                    <li>
                                                        <a href="<?php echo e(url('view-as-superadmin')); ?>">
                                                            ...
                                                            <?php if(Session::get('isSchoolAdmin')==TRUE): ?>
                                                                <?php echo app('translator')->getFromJson('lang.view'); ?> as  <?php echo app('translator')->getFromJson('lang.saas'); ?> <?php echo app('translator')->getFromJson('lang.admin'); ?>
                                                            <?php else: ?>
                                                                <?php echo app('translator')->getFromJson('lang.view'); ?> as  <?php echo app('translator')->getFromJson('lang.school'); ?> <?php echo app('translator')->getFromJson('lang.admin'); ?>
                                                            <?php endif; ?>
                                                        </a>
                                                    </li>
                                                <?php endif; ?>
...
<?php /**PATH /Applications/MAMP/htdocs/version/InfixEduV4.5/resources/views/backEnd/partials/menu.blade.php ENDPATH**/ ?>