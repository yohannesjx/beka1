...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->getFromJson('lang.assign_subject'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(url('dashboard')); ?>"><?php echo app('translator')->getFromJson('lang.dashboard'); ?></a>
                <a href="#"><?php echo app('translator')->getFromJson('lang.academics'); ?></a>
                <a href="#"><?php echo app('translator')->getFromJson('lang.assign_subject'); ?></a>
            </div>
        </div>
    </div>
</section>
        ...
        <?php if(in_array(251, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
            <div class="offset-lg-5 col-lg-3 text-right col-md-6 col-sm-6">
                <a href="<?php echo e(route('assign_subject_create')); ?>" class="primary-btn small fix-gr-bg">
                    ...
                    <?php echo app('translator')->getFromJson('lang.assign_subject'); ?>
                </a>
            </div>
        <?php endif; ?>
        </div>
    ...
    <div class="container-fluid p-0">
        <div class="row mt-40">
            <div class="col-lg-6 col-md-6">
                <div class="main-title">
                    <h3 class="mb-0"><?php echo app('translator')->getFromJson('lang.assign_subject'); ?> </h3>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php else: ?>
                                    <?php echo app('translator')->getFromJson('lang.not_assigned_yet'); ?>
                                <?php endif; ?>
                            </td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/academics/assign_subject.blade.php ENDPATH**/ ?>