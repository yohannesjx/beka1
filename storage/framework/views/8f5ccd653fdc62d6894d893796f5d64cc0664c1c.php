                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 mt-30-md">
                                    <select class="w-100 bb niceSelect form-control<?php echo e($errors->has('exam') ? ' is-invalid' : ''); ?>" name="exam">
                                        <option data-display="Select Exam *" value=""><?php echo app('translator')->getFromJson('lang.select'); ?> <?php echo app('translator')->getFromJson('lang.exam'); ?> *</option>
...
<section class="mt-20">
    <div class="container-fluid p-0">
        <div class="row mt-40">
            ...
            <div class="col-lg-6">
                <a href="<?php echo e(url('exam-schedule/print', [$exam_id, $class_id, $section_id])); ?>" class="primary-btn small fix-gr-bg pull-right" target="_blank"><i class="ti-printer"> </i> <?php echo app('translator')->getFromJson('lang.print'); ?></a>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <table class="display school-table school-table-style" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo e(@$exam_date != ""? App\SmGeneralSettings::DateConvater(@$exam_date):''); ?></td>
                            <?php $__currentLoopData = $exam_periods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exam_period): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <?php if(@$assigned_routine != ""): ?>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <span class="">
                                        ...
                                        <?php echo e(@$assigned_routine->subject->subject_name); ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/101.infixedu.v5/resources/views/backEnd/examination/exam_schedule_new.blade.php ENDPATH**/ ?>