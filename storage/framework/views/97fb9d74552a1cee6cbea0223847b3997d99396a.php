                                    ...
                                    <div class="row mt-40">
                                        <div class="col-lg-12">
                                            <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('style') ? ' is-invalid' : ''); ?>" name="style" id="style">
                                                ...
                                                <option value="1"><?php echo app('translator')->getFromJson('lang.dashboard'); ?> <?php echo app('translator')->getFromJson('lang.background'); ?></option>
                                                <option value="2"><?php echo app('translator')->getFromJson('lang.login'); ?> <?php echo app('translator')->getFromJson('lang.page'); ?> <?php echo app('translator')->getFromJson('lang.background'); ?></option>
                                            </select>
                                    ...
                                    <div class="row mt-40">
                                        <div class="col-lg-12"> 
                                            <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('background_type') ? ' is-invalid' : ''); ?>" name="background_type" id="background-type">
                                                ...
                                                <option value="color"><?php echo app('translator')->getFromJson('lang.color'); ?></option>
                                                <option value="image"><?php echo app('translator')->getFromJson('lang.image'); ?> (1920x1400)</option>
                                            </select>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if(@$background_setting->is_default==1): ?> 
                                                <a  class="primary-btn small fix-gr-bg " href="<?php echo e(url('/background_setting-status')); ?>/<?php echo e(@$background_setting->id); ?>"> <?php echo app('translator')->getFromJson('lang.activated'); ?> </a> 
                                            <?php else: ?>
                                            ...
                                            <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Disabled For Demo "> 
                                                ...
                                                <a  class="primary-btn small tr-bg" href="#"> <?php echo app('translator')->getFromJson('lang.make'); ?> <?php echo app('translator')->getFromJson('lang.default'); ?></a> 
                                                </span>
                                                <?php endif; ?>
                                            <?php else: ?>
                                            <?php if(in_array(489, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                                            <a  class="primary-btn small tr-bg" href="<?php echo e(url('/background_setting-status')); ?>/<?php echo e(@$background_setting->id); ?>"> <?php echo app('translator')->getFromJson('lang.make'); ?> <?php echo app('translator')->getFromJson('lang.default'); ?></a> 
                                        ...
                                        <td>
                                            ...
                                            <p class="primary-btn small tr-bg"><?php echo app('translator')->getFromJson('lang.disable'); ?></p>
                                            <?php else: ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/systemSettings/background_setting.blade.php ENDPATH**/ ?>