                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <button type="submit" class="primary-btn small fix-gr-bg">
                                        ...
                                        <?php echo app('translator')->getFromJson('lang.send'); ?> <?php echo app('translator')->getFromJson('lang.email'); ?>
                                    </button>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/feesCollection/search_fees_due.blade.php ENDPATH**/ ?>