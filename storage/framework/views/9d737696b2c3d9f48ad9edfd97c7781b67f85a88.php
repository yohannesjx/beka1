    ...
    <section class="sms-breadcrumb mb-40 white-box">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1><?php echo app('translator')->getFromJson('lang.update_course_heading_section'); ?></h1>
                <div class="bc-pages">
                    <a href="<?php echo e(url('dashboard')); ?>"><?php echo app('translator')->getFromJson('lang.dashboard'); ?></a>
                    <a href="#"><?php echo app('translator')->getFromJson('lang.front_settings'); ?></a>
                    <a href="#"><?php echo app('translator')->getFromJson('lang.update_course_heading_section'); ?></a>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="main-title">
                                <h3 class="mb-30">
                                    <?php echo app('translator')->getFromJson('lang.update_course_heading_section'); ?>
                                     
                                </h3>
                            </div> 
                            <?php if(in_array(526, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                                <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'course-heading-update',
                            ...
                            <div class="white-box">
                                ...
                                <div class="add-visitor <?php echo e(isset($update)? '':'isDisabled'); ?>">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="input-effect mt-25">
                                                ...
                                                <label> <?php echo app('translator')->getFromJson('lang.main'); ?> <?php echo app('translator')->getFromJson('lang.title'); ?><span>*</span></label>
                                                <span class="focus-border"></span>
                                            ...
                                            <div class="input-effect mt-25">
                                                <div class="input-effect">
                                                    ...
                                                    <label> <?php echo app('translator')->getFromJson('lang.main'); ?> <?php echo app('translator')->getFromJson('lang.description'); ?> <span>*</span> </label>
                                            ...
                                            <div class="input-effect mt-25">
                                                ...
                                                <label> <?php echo app('translator')->getFromJson('lang.button_text'); ?><span>*</span></label>
                                                <span class="focus-border"></span>
                                            ...
                                            <div class="input-effect mt-25">
                                                ...
                                                <label> <?php echo app('translator')->getFromJson('lang.button_url'); ?><span>*</span></label>
                                                <span class="focus-border"></span>
                                    ...
                                    <span class="mt-10"> <?php echo app('translator')->getFromJson('lang.image'); ?>(1420px*450px)</span>
                                    <div class="row no-gutters input-right-icon mt-35">
                                        <div class="col">
                                            <div class="input-effect">
                                        ...
                                        <div class="col-auto">
                                            <button class="primary-btn-small-input" type="button">
                                                <label class="primary-btn small fix-gr-bg"
                                                       for="browseFil"><?php echo app('translator')->getFromJson('lang.browse'); ?></label>
        ...
        <div class="modal-dialog modal-dialog-centered large-modal">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><?php echo app('translator')->getFromJson('lang.course'); ?> <?php echo app('translator')->getFromJson('lang.details'); ?></h4>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/course/courseHeadingUpdate.blade.php ENDPATH**/ ?>