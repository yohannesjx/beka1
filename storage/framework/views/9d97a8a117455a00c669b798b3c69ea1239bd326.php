    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="#"><?php echo app('translator')->getFromJson('lang.new'); ?> <?php echo app('translator')->getFromJson('lang.registration'); ?></a>
        ...
        <div class="container-fluid p-0">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <?php endif; ?>
                    <div class="white-box">
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'parentregistration/saas-student-list', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'parent-registration'])); ?>

                            <div class="row">
                                <input type="hidden" name="url" id="url" value="<?php echo e(URL::to('/')); ?>">
                                 <div class="col-lg-3">
                                    <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('institution') ? ' is-invalid' : ''); ?>" name="institution" id="select-school">
                                        <option data-display="<?php echo app('translator')->getFromJson('lang.select'); ?> <?php echo app('translator')->getFromJson('lang.institution'); ?>" value=""><?php echo app('translator')->getFromJson('lang.select'); ?> <?php echo app('translator')->getFromJson('lang.institution'); ?> *</option>
                                        <?php $__currentLoopData = $institutions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $institution): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($institution->id); ?>"><?php echo e($institution->school_name); ?></option>
                                ...
                                <div class="col-lg-3 mt-30-md" id="academic-year-div">
                                    ...
                                    <select class="niceSelect w-100 bb form-control" name="academic_year" id="select-academic-year">
                                        <option data-display="Select Academic Year" value=""><?php echo app('translator')->getFromJson('lang.select'); ?> <?php echo app('translator')->getFromJson('lang.academic_year'); ?></option>
                            ...
                            <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th><?php echo app('translator')->getFromJson('lang.class'); ?>(<?php echo app('translator')->getFromJson('lang.sec'); ?>)</th>
                                        <th><?php echo app('translator')->getFromJson('lang.academic_year'); ?></th>
                                        <th><?php echo app('translator')->getFromJson('lang.date_of_birth'); ?></th>
                                        <th><?php echo app('translator')->getFromJson('lang.guardian_name'); ?></th>
                                        <th><?php echo app('translator')->getFromJson('lang.guardian_mobile'); ?></th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <a class="dropdown-item" href="<?php echo e(url('parentregistration/student-view', [$student->id])); ?>"  data-id="<?php echo e($student->id); ?>"  ><?php echo app('translator')->getFromJson('lang.view'); ?></a>

                                                 <a onclick="deleteId(<?php echo e($student->id); ?>);" class="dropdown-item" href="#" data-toggle="modal" data-target="#deleteStudentModal" data-id="<?php echo e($student->id); ?>"  ><?php echo app('translator')->getFromJson('lang.approve'); ?></a>

                                                 <a onclick="enableId(<?php echo e($student->id); ?>);" class="dropdown-item" href="#" data-toggle="modal" data-target="#enableStudentModal" data-id="<?php echo e($student->id); ?>"  ><?php echo app('translator')->getFromJson('lang.delete'); ?></a>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><?php echo app('translator')->getFromJson('lang.student'); ?> <?php echo app('translator')->getFromJson('lang.approve'); ?></h4>
            ...
            <div class="modal-body">
                ...
                <div class="text-center">
                    <h4><?php echo app('translator')->getFromJson('lang.are_you_sure_to_approve'); ?></h4>
                </div>
                ...
                <input type="hidden" name="id" value="<?php echo e(@$student->id); ?>" id="student_delete_i">  
                        <button class="primary-btn fix-gr-bg" type="submit"><?php echo app('translator')->getFromJson('lang.approve'); ?></button>
                     <?php echo e(Form::close()); ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/101.infixedu.v5/Modules/ParentRegistration/Resources/views/saas_student_list.blade.php ENDPATH**/ ?>