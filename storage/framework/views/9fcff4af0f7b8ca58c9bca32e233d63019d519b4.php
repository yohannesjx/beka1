                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                           ...
                                           <?php if(in_array(164, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                                            ...
                                            <a  class="dropdown-item" href="#" data-toggle="modal" data-target="#deleteStaffModal<?php echo e($value->id); ?>" data-id="<?php echo e($value->id); ?>"  ><?php echo app('translator')->getFromJson('lang.delete'); ?></a>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/version/InfixEduV4.5/resources/views/backEnd/humanResource/staff_list.blade.php ENDPATH**/ ?>