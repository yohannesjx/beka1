        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php else: ?>
                            <?php if(in_array(457, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
            ...
            <div class="col-lg-9">
                <div class="row">
                    ...
                    <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Disabled Images <?php echo app('translator')->getFromJson('lang.backup'); ?>">
                            <button class="primary-btn small fix-gr-bg  demo_view" style="pointer-events: none;" type="button" >Images <?php echo app('translator')->getFromJson('lang.backup'); ?></button>
                          </span>
                              <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Disabled Full Project <?php echo app('translator')->getFromJson('lang.backup'); ?>">
                            <button class="primary-btn small fix-gr-bg  demo_view" style="pointer-events: none;" type="button" >Full Project <?php echo app('translator')->getFromJson('lang.backup'); ?></button>
                          </span>
                          <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Disabled Database <?php echo app('translator')->getFromJson('lang.backup'); ?>">
                            <button class="primary-btn small fix-gr-bg  demo_view" style="pointer-events: none;" type="button" >Database <?php echo app('translator')->getFromJson('lang.backup'); ?></button>
                          </span>
                    <?php else: ?>
                    <?php if(in_array(460, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                    ...
                    <?php endif; ?> 
                    <?php if(in_array(461, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                ...
                <?php endif; ?> 
                <?php if(in_array(462, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                        ...
                        <table class="display school-table school-table-style" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php if(in_array(458, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                                    ...
                                    <?php endif; ?>
                                        ...
                                        <?php if(in_array(459, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/systemSettings/backupSettings.blade.php ENDPATH**/ ?>