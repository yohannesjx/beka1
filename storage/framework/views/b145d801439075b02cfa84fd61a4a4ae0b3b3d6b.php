                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                     ...
                                     <!--    <a class="dropdown-item" href="<?php echo e(url('approve-leave/'.$value->id.'/edit')); ?>">edit</a> -->
                                        ...
                                        <?php if(@$value->upload_file != ""): ?>
                                            <?php if(@in_array(28, App\GlobalVariable::GlobarModuleLinks())): ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/studentPanel/assignmentList.blade.php ENDPATH**/ ?>