...
<section class="sms-breadcrumb mb-40 white-box up_breadcrumb">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->getFromJson('lang.manage'); ?> <?php echo app('translator')->getFromJson('lang.phone_call_log'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(url('dashboard')); ?>"><?php echo app('translator')->getFromJson('lang.dashboard'); ?></a>
                <a href="#"><?php echo app('translator')->getFromJson('lang.admin_section'); ?></a>
                <a href="#"><?php echo app('translator')->getFromJson('lang.phone_call_log'); ?></a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container-fluid p-0">
        ...
        <div class="row">
            <div class="offset-lg-10 col-lg-2 text-right col-md-12 mb-20">
                <a href="<?php echo e(url('phone-call')); ?>" class="primary-btn small fix-gr-bg">
                        ...
                        <div class="main-title">
                            <h3 class="mb-30"><?php if(isset($phone_call_log)): ?>
                                ...
                                <?php else: ?>
                                    <?php echo app('translator')->getFromJson('lang.add'); ?>
                                <?php endif; ?>
                                <?php echo app('translator')->getFromJson('lang.phone_call'); ?>
                            </h3>
                        </div>
                        <?php if(isset($phone_call_log)): ?>
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'phone-call/'.@$phone_call_log->id, 'method' => 'PUT', 'enctype' => 'multipart/form-data'])); ?>

                        <?php else: ?>
                        <?php if(in_array(37, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'phone-call',
                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->getFromJson('lang.name'); ?></label>
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            <input class="primary-input form-control<?php echo e(@$errors->has('phone') ? ' is-invalid' : ''); ?>" id="apply_date" type="text"
                                ...
                                <div class="row no-gutters input-right-icon mt-25">
                                    <div class="col">
                                        <div class="input-effect">
                                            ...
                                            <span class="focus-border"></span>
                                            <label><?php echo app('translator')->getFromJson('lang.follow_up_date'); ?> <span></span></label>
                                        </div>
                                    </div>
                                    <div class="col-auto">
                                        <button class="" type="button">
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->getFromJson('lang.call_duration'); ?></label>
                                            <span class="focus-border"></span>
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12 d-flex">
                                        <p class="text-uppercase fw-500 mb-10"><?php echo app('translator')->getFromJson('lang.type'); ?></p>
                                        <div class=" radio-btn-flex ml-20">
                                            ...
                                            <div class="mr-30">
                                                ...
                                                <label for="relationFather"><?php echo app('translator')->getFromJson('lang.incoming'); ?></label>
                                            </div><br>
                                            <div class="mr-30">
                                                ...
                                                <label for="relationMother"><?php echo app('translator')->getFromJson('lang.outgoing'); ?></label>
                                            </div>
                                            <?php else: ?>
                                            <div class="mr-30">
            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-0"><?php echo app('translator')->getFromJson('lang.phone_call'); ?> <?php echo app('translator')->getFromJson('lang.list'); ?></h3>
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th><?php echo app('translator')->getFromJson('lang.follow_up_date'); ?></th>
                                    <th><?php echo app('translator')->getFromJson('lang.call_duration'); ?></th>
                                    <th><?php echo app('translator')->getFromJson('lang.description'); ?></th>
                                    <th><?php echo app('translator')->getFromJson('lang.call'); ?> <?php echo app('translator')->getFromJson('lang.type'); ?></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo e(@$phone_call_log->date != ""? App\SmGeneralSettings::DateConvater(@$phone_call_log->date):''); ?>                                   
                                    </td>
                                    <td>
                                        <?php echo e(@$phone_call_log->next_follow_up_date != ""? App\SmGeneralSettings::DateConvater(@$phone_call_log->next_follow_up_date):''); ?>                                       
                                    </td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <?php if(in_array(38, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                                                <a class="dropdown-item" href="<?php echo e(url('phone-call', [@$phone_call_log->id
                                                    ])); ?>"><?php echo app('translator')->getFromJson('lang.edit'); ?></a>
                                                    <?php endif; ?>
                                                     <?php if(in_array(39, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title"><?php echo app('translator')->getFromJson('lang.delete'); ?> <?php echo app('translator')->getFromJson('lang.phone_call'); ?></h4>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mt-40 d-flex justify-content-between">
                                                    <button type="button" class="primary-btn tr-bg" data-dismiss="modal"><?php echo app('translator')->getFromJson('lang.cancel'); ?></button>
                                                     <?php echo e(Form::open(['url' => 'phone-call/'.@$phone_call_log->id, 'method' => 'DELETE', 'enctype' => 'multipart/form-data'])); ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/admin/phone_call.blade.php ENDPATH**/ ?>