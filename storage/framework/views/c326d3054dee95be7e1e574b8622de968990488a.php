                ...
                <div class="white-box">
                    ...
                    <div class="row mt-40">
                        <div class="col-lg-12 text-center">
                            ...
                            <?php if(Illuminate\Support\Facades\Config::get('app.app_sync')): ?>
                                <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Disabled For Demo "> <button class="primary-btn small fix-gr-bg  demo_view" style="pointer-events: none;" type="button" > <?php echo app('translator')->getFromJson('lang.update'); ?></button></span>
                            <?php else: ?>
                                <?php if(in_array(409, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/version/InfixEduV4.5/resources/views/backEnd/systemSettings/updateGeneralSettings.blade.php ENDPATH**/ ?>