            ...
            <div class="col-lg-4 no-gutters">
                <div class="d-flex justify-content-between">
                    <div class="main-title">
                        <h3 class="mb-30"><?php echo app('translator')->getFromJson('lang.add_fees'); ?> </h3>
                    </div>
                </div>
            </div>
        </div>
                ...
                <table class="display school-table school-table-style" cellspacing="0" width="100%" id="mytable">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th><?php echo app('translator')->getFromJson('lang.payment'); ?></th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if(App\SmGeneralSettings::isModule('RazorPay') == TRUE && !empty($is_RazorPay)): ?>
                                    <form id="rzp-footer-form_<?php echo e($count); ?>" action="<?php echo url('razorpay/dopayment'); ?>" method="POST" style="width: 100%; text-align: center" >
                                        ...
                                        <input type="hidden" name="amount" id="amount" value="<?php echo e($rest_amount * 100); ?>"/>
                                        ...
                                        <input type="hidden" name="amount" id="amount" value="<?php echo e($rest_amount); ?>"/>
                                        <div class="pay">
                            ...
                            <tr>
                                ...
                                <?php elseif(@$payment->payment_mode == "DD"): ?>
                                    <?php echo e('DD'); ?>

                                <?php elseif(@$payment->payment_mode == "PS"): ?>
                                    <?php echo e('Paystack'); ?>

                                <?php elseif(@$payment->payment_mode == "RP"): ?>
                                    <?php echo e('Razorpay'); ?>
                    ...
                    <tfoot>
                        <tr>
                            <th></th>
                            <th></th>
                            <th><?php echo app('translator')->getFromJson('lang.grand'); ?> <?php echo app('translator')->getFromJson('lang.total'); ?> (<?php echo e(@$currency); ?>)</th>
                            <th></th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center">
                    <h4><?php echo app('translator')->getFromJson('lang.are_you_sure_to_detete_this_item'); ?>?</h4>
                </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/studentPanel/fees_pay.blade.php ENDPATH**/ ?>