                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="white-box">
                            ...
                            <?php if(isset($editData->logo) && !empty($editData->logo)): ?>                            
                                <img class="img-fluid Img-100" src="<?php echo e(asset('/')); ?><?php echo e($editData->logo); ?>" alt="" >
                            <?php else: ?>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="white-box">
                            ...
                            <?php if(isset($editData->favicon) && !empty($editData->favicon)): ?>                            
                                <img class="img-fluid Img-50" src="<?php echo e(asset('/')); ?><?php echo e($editData->favicon); ?>" alt="" >
                            <?php else: ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/101.infixedu.v5/Modules/Saas/Resources/views/systemSettings/generalSettingsView.blade.php ENDPATH**/ ?>