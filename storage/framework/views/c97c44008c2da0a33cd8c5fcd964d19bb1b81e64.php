                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect">
                                        <select class="niceSelect w-100 bb form-control" name="marital_status">
                                            <option data-display="Marital Status" value=""><?php echo app('translator')->getFromJson('lang.marital_status'); ?></option>
                                            
                                            <option value="married" <?php echo e($editData->marital_status == "married"? 'selected':''); ?>><?php echo app('translator')->getFromJson('lang.married'); ?></option>
                                            <option value="unmarried" <?php echo e($editData->marital_status == "unmarried"? 'selected':''); ?>><?php echo app('translator')->getFromJson('lang.unmarried'); ?></option>
                    ...
                    <div class="col-lg-3">
                        <div class="input-effect">
                            <select class="niceSelect w-100 bb form-control" name="contract_type">
                                ...
                                <?php endif; ?>
                                <?php endif; ?>
                                ><?php echo app('translator')->getFromJson('lang.permanent'); ?> </option>
                                ...
                                <?php endif; ?>
                                <?php endif; ?>
                                > <?php echo app('translator')->getFromJson('lang.contract'); ?></option>
                            </select>
                            <span class="focus-border"></span>
...
<div class="row mt-40">
    <div class="col-lg-12 text-center">
            <?php if(Illuminate\Support\Facades\Config::get('app.app_sync')): ?>
            <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Disabled For Demo "> <button class="primary-btn small fix-gr-bg  demo_view" style="pointer-events: none;" type="button" > <?php echo app('translator')->getFromJson('lang.update_staff'); ?></button></span>
        <?php else: ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/humanResource/editStaff.blade.php ENDPATH**/ ?>