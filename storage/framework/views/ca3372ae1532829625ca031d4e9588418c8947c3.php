                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 mt-30-md" id="select_subject_div">
                                <select class="w-100 bb niceSelect form-control<?php echo e($errors->has('subject') ? ' is-invalid' : ''); ?> select_subject" id="select_subject" name="subject">
                                    <option data-display="Select subject *" value=""><?php echo app('translator')->getFromJson('lang.select_subjects'); ?> *</option>
                                </select>
        ...
        <div class="row">
            <div class="col-lg-12">
                <table class="display school-table school-table-style" cellspacing="0" width="100%" >
                    <thead>
                        <tr>
                            <th rowspan="2" ><?php echo app('translator')->getFromJson('lang.admission_no'); ?>.</th>
                            <th rowspan="2" ><?php echo app('translator')->getFromJson('lang.roll_no'); ?>.</th>
                            <th rowspan="2" ><?php echo app('translator')->getFromJson('lang.student'); ?></th>
                            <th colspan="<?php echo e(@$number_of_exam_parts); ?>"> <?php echo e(@$subjectNames->subject_name); ?></th> 
                            <th rowspan="2"><?php echo app('translator')->getFromJson('lang.is_present'); ?></th>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="hidden" name="exam_setup_ids[]" value="<?php echo e(@$part->id); ?>">
                                    ...
                                    <label><?php echo e(@$part->exam_title); ?> <?php echo app('translator')->getFromJson('lang.mark'); ?></label>
                            ...
                            <td>
                                <div class="input-effect">
                                    ...
                                    <label for="subject_<?php echo e(@$student->id); ?>_<?php echo e(@$student->admission_no); ?>"><?php echo app('translator')->getFromJson('lang.yes'); ?></label>
                                </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/examination/masks_register.blade.php ENDPATH**/ ?>