                            ...
                            <div class="col-lg-3">
                                <div class="input-effect">
                                    <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('session') ? ' is-invalid' : ''); ?>" name="session">
                                        ...
                                        <option value="<?php echo e($session->id); ?>" <?php echo e($student->session_id == $session->id? 'selected':''); ?>><?php echo e($session->year); ?></option>
                                        <?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/studentInformation/student_edit.blade.php ENDPATH**/ ?>