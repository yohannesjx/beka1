...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->getFromJson('lang.class_routine_create'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(url('dashboard')); ?>"><?php echo app('translator')->getFromJson('lang.dashboard'); ?></a>
                <a href="#"><?php echo app('translator')->getFromJson('lang.academics'); ?></a>
                <a href="#"><?php echo app('translator')->getFromJson('lang.class_routine_create'); ?></a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container-fluid p-0">
        <div class="row mt-40">
            <div class="col-lg-6 col-md-6">
                <div class="main-title">
                    <h3 class="mb-30"><?php echo app('translator')->getFromJson('lang.class_routine_create'); ?></h3>
                </div>
            </div>
            <div class="col-lg-6 pull-right">
                <a href="<?php echo e(url('class-routine/print', [$class_id, $section_id])); ?>" class="primary-btn small fix-gr-bg pull-right" target="_blank"><i class="ti-printer"> </i> <?php echo app('translator')->getFromJson('lang.print'); ?></a>                
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <table class="display school-table school-table-style" cellspacing="0" width="100%">
                    <thead>
                        ...
                        <?php endif; ?>
                        <tr>
                            <th><?php echo app('translator')->getFromJson('lang.class'); ?> <?php echo app('translator')->getFromJson('lang.period'); ?></th>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="col-lg-6 text-right">
                                    <a href="<?php echo e(url('add-new-routine', [$class_time->id, $sm_weekend->id, $class_id, $section_id])); ?>" class="primary-btn small tr-bg icon-only mr-10 modalLink" data-modal-size="modal-md" title="<?php echo app('translator')->getFromJson('lang.create_class_routine'); ?>">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/academics/class_routine_new.blade.php ENDPATH**/ ?>