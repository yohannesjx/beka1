...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->getFromJson('lang.notice_board'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(url('dashboard')); ?>"><?php echo app('translator')->getFromJson('lang.dashboard'); ?></a>
                <a href="#"><?php echo app('translator')->getFromJson('lang.communicate'); ?></a>
                <a href="#"><?php echo app('translator')->getFromJson('lang.notice_board'); ?></a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-5">
                <div class="main-title">
                    <h3 class="mb-30"><?php echo app('translator')->getFromJson('lang.all'); ?> <?php echo app('translator')->getFromJson('lang.notices'); ?></h3>
                </div>
            </div>
            ...
            <div class="offset-lg-5 col-lg-3 text-right col-md-6 col-7">
                <a href="<?php echo e(url('add-notice')); ?>" class="primary-btn small fix-gr-bg">
                    ...
                    <?php echo app('translator')->getFromJson('lang.add'); ?> <?php echo app('translator')->getFromJson('lang.notice'); ?>
                </a>
            </div>
            <?php endif; ?>
        </div>
                        ...
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <?php if(in_array(289, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                             <a href="<?php echo e(url('edit-notice/'.$value->id)); ?>">
                                <button type="submit" class="primary-btn small tr-bg mr-10"><?php echo app('translator')->getFromJson('lang.edit'); ?> </button>
                             </a>
                             <?php endif; ?>
                              <?php if(in_array(290, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                                <a class="deleteUrl" data-modal-size="modal-md" title="Delete Notice" href="<?php echo e(url('delete-notice-view/'.$value->id)); ?>"><button class="primary-btn small tr-bg"><?php echo app('translator')->getFromJson('lang.delete'); ?> </button></a>
                            <?php endif; ?>
                            </div>
                        </div>
                    </a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <p class="mb-0">
                                        ...
                                        <?php echo app('translator')->getFromJson('lang.publish'); ?>  <?php echo app('translator')->getFromJson('lang.date'); ?> :    
                                         <?php echo e(@$value->publish_on != ""? App\SmGeneralSettings::DateConvater(@$value->publish_on):''); ?>

                                    </p>
                                    <p class="mb-0">
                                        <span class="ti-calendar mr-10"></span>
                                        <?php echo app('translator')->getFromJson('lang.notice'); ?>  <?php echo app('translator')->getFromJson('lang.date'); ?> :                                         
                                        <?php echo e(@$value->notice_date != ""? App\SmGeneralSettings::DateConvater(@$value->notice_date):''); ?>

                                    </p>
                                    <p>
                                        <span class="ti-user mr-10"></span>
                                        <?php echo app('translator')->getFromJson('lang.created_by'); ?> : <?php echo e(@$value->users !=""?@$value->users->full_name:""); ?>
                                    ...
                                    if (!empty($rolesData)) {
                                        ?>
                                        <h4><?php echo app('translator')->getFromJson('lang.message'); ?> <?php echo app('translator')->getFromJson('lang.to'); ?></h4>
                                        <?php
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/101.infixedu.v5/resources/views/backEnd/communicate/noticeList.blade.php ENDPATH**/ ?>