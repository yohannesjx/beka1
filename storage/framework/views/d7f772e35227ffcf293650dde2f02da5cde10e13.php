...
<html lang="en">
  ...
  <link rel="stylesheet" href="<?php echo e(asset('/')); ?>/public/backEnd/css/report/bootstrap.min.css">
    ...
    <title><?php echo app('translator')->getFromJson('lang.student'); ?> <?php echo app('translator')->getFromJson('lang.fees'); ?></title>
  <style>
    *{
      margin: 0;
      padding: 0;
      ...
      <table class="custom_table">
        ...
        <?php $__currentLoopData = $fees_assigneds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fees_assigned): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <tr>
             <!-- first td wrap  -->
            <td class="border-top">
                <p><?php echo e($fees_assigned->feesGroupMaster!=""?$fees_assigned->feesGroupMaster->feesGroups->name:""); ?> [<?php echo e($fees_assigned->feesGroupMaster!=""?$fees_assigned->feesGroupMaster->feesTypes->name:""); ?>]</p></td>
            <td class="border-top"> 
          ...
          <tr>
            ...
            <td><strong> <?php echo e(number_format((float) $totalpayable, 2, '.', '')); ?> </strong> </td>
...
</html><?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/feesCollection/fees_payment_invoice_print.blade.php ENDPATH**/ ?>