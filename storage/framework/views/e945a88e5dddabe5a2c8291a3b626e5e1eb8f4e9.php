...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->getFromJson('lang.fees_assign'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(url('dashboard')); ?>"><?php echo app('translator')->getFromJson('lang.dashboard'); ?></a>
                <a href="#"><?php echo app('translator')->getFromJson('lang.fees_collection'); ?></a>
                <a href="<?php echo e(route('fees_assign', [$fees_group_id])); ?>"><?php echo app('translator')->getFromJson('lang.fees_assign'); ?></a>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-lg-12">
                    <div class="row mb-30">
                        <div class="col-lg-6 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-0"><?php echo app('translator')->getFromJson('lang.assign'); ?> <?php echo app('translator')->getFromJson('lang.fees_group'); ?></h3>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <td colspan="7">
                                        <div class="text-center">
                                            <button type="button" class="primary-btn fix-gr-bg mb-0" id="btn-assign-fees-group" data-loading-text="<i class='fas fa-spinner'></i> Processing Data">
                                                ...
                                                <?php echo app('translator')->getFromJson('lang.save'); ?> <?php echo app('translator')->getFromJson('lang.fees'); ?>
                                            </button>
                                        </div>
                                    </td>
                                </tr>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/version/InfixEduV4.5/resources/views/backEnd/feesCollection/fees_assign.blade.php ENDPATH**/ ?>