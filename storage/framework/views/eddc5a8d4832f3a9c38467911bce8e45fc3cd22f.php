        ...
        <div class="row">
                ...
                <!-- Select a Payment Gateway -->    
                 <div class="col-lg-3">
                    ...
                    <?php if(in_array(413, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                        ...
                        <div class="row mt-40">
                            <div class="col-lg-12">
                                 ...
                                 <?php $__currentLoopData = $paymeny_gateway; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <?php if(App\SmGeneralSettings::isModule('RazorPay') == FALSE && $value->method =="Razorpay" ): ?>  <?php continue; ?> <?php endif; ?>
            ...
            <div class="col-lg-9">
                 <ul class="nav nav-tabs justify-content-end mt-sm-md-20 mb-30" role="tablist">
                    ...
                    <?php if(App\SmGeneralSettings::isModule('RazorPay') == FALSE && $row->gateway_name =="Razorpay" ): ?>   <?php continue; ?> <?php endif; ?>
                        <li class="nav-item">
                ...
                <div class="tab-content">
                    ...
                    <?php $__currentLoopData = $paymeny_gateway_settings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                            ...
                            <div role="tabpanel" class="tab-pane fade   <?php if(@$row->gateway_name=='PayPal'): ?> active show <?php endif; ?> " id="<?php echo e(@$row->gateway_name); ?>">
                                ...
                                <?php if(in_array(414, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/101.infixedu.v5/resources/views/backEnd/systemSettings/paymentMethodSettings.blade.php ENDPATH**/ ?>