...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->getFromJson('lang.human_resource'); ?></h1>
            <div class="bc-pages">
...
<section class="mb-40 student-details">
    ...
    <div class="container-fluid p-0">
        <div class="row">
         <div class="col-lg-3">
            ...
            <div class="main-title">
                <h3 class="mb-20"><?php echo app('translator')->getFromJson('lang.staff'); ?> <?php echo app('translator')->getFromJson('lang.details'); ?></h3>
            </div>
                ...
                <div class="white-box">
                    <div class="single-meta mt-10">
                        <div class="d-flex justify-content-between">
                            <div class="name">
                                <?php echo app('translator')->getFromJson('lang.staff_name'); ?>
                            </div>
                            <div class="value">
            ...
            <div class="single-meta">
                <div class="d-flex justify-content-between">
                    <div class="name">
                        <?php echo app('translator')->getFromJson('lang.epf_no'); ?>
                    </div>
                    <div class="value">
           ...
           <div class="single-meta">
            <div class="d-flex justify-content-between">
                <div class="name">
                    <?php echo app('translator')->getFromJson('lang.basic_salary'); ?>
                </div>
                <div class="value">
        ...
        <div class="single-meta">
            <div class="d-flex justify-content-between">
                <div class="name">
                    <?php echo app('translator')->getFromJson('lang.contract_type'); ?>
                </div>
                <div class="value">
...
<div class="col-lg-9 staff-details">
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" href="#payroll" role="tab" data-toggle="tab"><?php echo app('translator')->getFromJson('lang.payroll'); ?></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#leaves" role="tab" data-toggle="tab"><?php echo app('translator')->getFromJson('lang.leave'); ?></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#staffDocuments" role="tab" data-toggle="tab"><?php echo app('translator')->getFromJson('lang.documents'); ?></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#staffTimeline" role="tab" data-toggle="tab"><?php echo app('translator')->getFromJson('lang.timeline'); ?></a>
        </li>
                ...
                <div class="single-info">
                    <div class="row">
                        <div class="col-lg-5 col-md-5">
                            <div class="">
                                <?php echo app('translator')->getFromJson('lang.mobile'); ?> <?php echo app('translator')->getFromJson('lang.no'); ?>
                            </div>
                        </div>
                ...
                <div class="single-info">
                    <div class="row">
                        <div class="col-lg-5 col-md-6">
                            <div class="">
                               <?php echo app('translator')->getFromJson('lang.emergency_mobile'); ?>
                           </div>
                       </div>
...
<?php echo e($staffDetails->date_of_birth != ""? App\SmGeneralSettings::DateConvater($staffDetails->date_of_birth):''); ?>
        ...
        <div class="single-info">
            <div class="row">
                <div class="col-lg-5 col-md-6">
                    <div class="">
                       <?php echo app('translator')->getFromJson('lang.marital_status'); ?>
                   </div>
               </div>
    ...
    <div class="single-info">
        <div class="row">
            <div class="col-lg-5 col-md-6">
                <div class="">
                    <?php echo app('translator')->getFromJson('lang.qualifications'); ?>
                </div>
            </div>
    ...
    <div class="single-info">
        <div class="row">
            <div class="col-lg-5 col-md-6">
                <div class="">
                   <?php echo app('translator')->getFromJson('lang.work_experience'); ?>
               </div>
           </div>
...
<!-- Start Parent Part -->
<h4 class="stu-sub-head mt-40"><?php echo app('translator')->getFromJson('lang.address'); ?></h4>
<div class="single-info">
    <div class="row">
        <div class="col-lg-5 col-md-5">
            <div class="">
                <?php echo app('translator')->getFromJson('lang.current_address'); ?>
            </div>
        </div>
...
<h4 class="stu-sub-head mt-40"><?php echo app('translator')->getFromJson('lang.bank'); ?> <?php echo app('translator')->getFromJson('lang.account'); ?> <?php echo app('translator')->getFromJson('lang.details'); ?></h4>
<div class="single-info">
    <div class="row">
        <div class="col-lg-5 col-md-5">
            <div class="">
                <?php echo app('translator')->getFromJson('lang.account_name'); ?>
            </div>
        </div>
...
<div class="single-info">
    <div class="row">
        <div class="col-lg-5 col-md-5">
            <div class="">
               <?php echo app('translator')->getFromJson('lang.branch_name'); ?>
           </div>
       </div>
...
<h4 class="stu-sub-head mt-40"><?php echo app('translator')->getFromJson('lang.social_links_details'); ?></h4>
<div class="single-info">
    <div class="row">
        <div class="col-lg-5 col-md-5">
            <div class="">
                <?php echo app('translator')->getFromJson('lang.facebook_url'); ?>
            </div>
        </div>
...
<div class="single-info">
    <div class="row">
        <div class="col-lg-5 col-md-5">
            <div class="">
                <?php echo app('translator')->getFromJson('lang.twitter_url'); ?>
            </div>
        </div>
...
<div class="single-info">
    <div class="row">
        <div class="col-lg-5 col-md-5">
            <div class="">
                <?php echo app('translator')->getFromJson('lang.linkedin_url'); ?>
            </div>
        </div>
...
<div class="single-info">
    <div class="row">
        <div class="col-lg-5 col-md-5">
            <div class="">
                <?php echo app('translator')->getFromJson('lang.instragram_url'); ?>
            </div>
        </div>
...
<div role="tabpanel" class="tab-pane fade" id="payroll">
    <div class="white-box">
        ...
        <thead>
            <tr>
                <th width="5%"><?php echo app('translator')->getFromJson('lang.payslip'); ?> <?php echo app('translator')->getFromJson('lang.id'); ?></th>
                <th width="20%"><?php echo app('translator')->getFromJson('lang.month'); ?>-<?php echo app('translator')->getFromJson('lang.year'); ?></th>
                <th width="15%"><?php echo app('translator')->getFromJson('lang.date'); ?></th>
                <th width="15%"><?php echo app('translator')->getFromJson('lang.mode_of_payment'); ?></th>
                <th width="15%"><?php echo app('translator')->getFromJson('lang.net_salary'); ?>(<?php echo e($currency); ?>)</th>
                <th width="12%"><?php echo app('translator')->getFromJson('lang.status'); ?></th>
                <th width="20%"><?php echo app('translator')->getFromJson('lang.action'); ?></th>
            </tr>
        </thead>
...
<?php echo e($value->created_at != ""? App\SmGeneralSettings::DateConvater($value->created_at):''); ?>
                ...
                <td>
                    <?php if($value->payroll_status == 'P'): ?>
                    <a class="modalLink" data-modal-size="modal-lg" title="View Payslip Details" href="<?php echo e(url('view-payslip', $value->id)); ?>"><button class="primary-btn small tr-bg"> <?php echo app('translator')->getFromJson('lang.view'); ?> <?php echo app('translator')->getFromJson('lang.payslip'); ?></button></a>
                    <?php endif; ?>
                </td>
            </tr>
            ...
            <tr class="justify-content-center">
                <td colspan="7" class="justify-content-center text-center"><?php echo app('translator')->getFromJson('lang.no_payroll_data'); ?></td>
            </tr>
            <?php endif; ?>
        </tbody>
    </table>
        ...
        <div class="row mt-30">
            <div class="col-lg-12">
                <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th><?php echo app('translator')->getFromJson('lang.leave_type'); ?></th>
                            <th><?php echo app('translator')->getFromJson('lang.leave_from'); ?> </th>
                            <th><?php echo app('translator')->getFromJson('lang.leave_to'); ?></th>
...
<?php echo e($value->apply_date != ""? App\SmGeneralSettings::DateConvater($value->apply_date):''); ?>
                        ...
                        <td>
                            ...
                            <button class="primary-btn small bg-success text-white border-0"> <?php echo app('translator')->getFromJson('lang.approved'); ?></button>
                            <?php endif; ?>
                        ...
                        <td>
                            <a class="modalLink" data-modal-size="modal-md" title="View Leave Details" href="<?php echo e(url('view-leave-details', $value->id)); ?>"><button class="primary-btn small tr-bg"> <?php echo app('translator')->getFromJson('lang.view'); ?> </button></a>
                        </td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php else: ?> 
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td><?php echo app('translator')->getFromJson('lang.not_leaves_data'); ?></td>
                        <td></td>
                        <td></td>
                    </tr>
                    <?php endif; ?> 
...
<div role="tabpanel" class="tab-pane fade" id="staffDocuments">
    <div class="white-box">
        ...
        cellspacing="0">
            <thead class="d-block">
                <tr class="d-flex">
                    <th class="col-8"><?php echo app('translator')->getFromJson('lang.document'); ?> <?php echo app('translator')->getFromJson('lang.title'); ?></th>
                    <th class="col-4"><?php echo app('translator')->getFromJson('lang.action'); ?></th>
                </tr>
            </thead>
            ...
            <tbody class="d-block">
                ...
                <tr class="d-flex">
                    <td class="col-8"><?php echo app('translator')->getFromJson('lang.joining_letter'); ?></td>
                    <td class="col-4">
                        <a href="<?php echo e(url('download-staff-joining-letter/'.showJoiningLetter($staffDetails->joining_letter))); ?>">
                            <button class="primary-btn tr-bg text-uppercase bord-rad">
                                <?php echo app('translator')->getFromJson('lang.download'); ?>
                ...
                <tr class="d-flex">
                    <td class="col-8"><?php echo app('translator')->getFromJson('lang.resume'); ?></td>
                    <td class="col-4">
                ...
                <tr class="d-flex">
                    <td class="col-8"><?php echo app('translator')->getFromJson('lang.other_documents'); ?></td>
                    <td class="col-4">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/humanResource/viewStaff.blade.php ENDPATH**/ ?>