        ...
        <div class="container-fluid p-0">
            <div class="row mt-40">
                <div class="col-lg-6 col-md-6">
                    <div class="main-title">
                        <h3 class="mb-30"><?php echo app('translator')->getFromJson('lang.assign'); ?> <?php echo app('translator')->getFromJson('lang.optional'); ?> <?php echo app('translator')->getFromJson('lang.subject'); ?> - (<?php echo e(@$subject_info->subject_name); ?>)  </h3>
                    </div>
                </div>
                            ...
                            <div class="row">
                                        ...
                                        <table id="table_id1" class="display school-table" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><?php echo app('translator')->getFromJson('lang.admission_no'); ?>.</th>
                                                    <th><?php echo app('translator')->getFromJson('lang.name'); ?></th>
                                                    <th><?php echo app('translator')->getFromJson('lang.optional'); ?> <?php echo app('translator')->getFromJson('lang.subject'); ?></th>   
                                                </tr>
                                            </thead>
                                ...
                                <div class="col-lg-12 mt-20 text-right">
                                    <button type="submit" class="primary-btn small fix-gr-bg">
                                        ...
                                        <?php echo app('translator')->getFromJson('lang.assign'); ?>  <?php echo app('translator')->getFromJson('lang.subject'); ?>
                                    </button>
                                </div>
                                <?php endif; ?>
                            </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/academics/assign_optional_subject.blade.php ENDPATH**/ ?>