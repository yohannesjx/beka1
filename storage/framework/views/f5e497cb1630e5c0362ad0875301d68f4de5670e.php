                                ...
                                <div class="add-visitor <?php echo e(isset($update)? '':'isDisabled'); ?>">
                                    ...
                                    <div class="row no-gutters input-right-icon mt-35">
                                        ...
                                        <div class="col-auto">
                                            <button class="primary-btn-small-input" type="button">
                                                <label class="primary-btn small fix-gr-bg"
                                                       for="browseFileMailFile"><?php echo app('translator')->getFromJson('lang.browse'); ?></label>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/site/beka_school/resources/views/frontEnd/about_us.blade.php ENDPATH**/ ?>