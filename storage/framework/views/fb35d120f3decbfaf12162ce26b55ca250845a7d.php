...
<?php if(@in_array(20, App\GlobalVariable::GlobarModuleLinks())): ?>
    <li>
        ...
        <ul class="collapse list-unstyled" id="subMenuStudentFeesCollection">
            ...
            <?php else: ?>
            <li>
                <a href="<?php echo e(url('feescollection/student-fees')); ?>"><?php echo app('translator')->getFromJson('lang.pay_fees'); ?></a>
            </li>
...
<?php endif; ?>
<?php /**PATH /Users/test/site/beka_school/resources/views/backEnd/partials/student_sidebar.blade.php ENDPATH**/ ?>